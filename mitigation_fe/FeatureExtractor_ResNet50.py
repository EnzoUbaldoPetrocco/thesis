...
class FeatureExtractor:
    ...
    preprocessing_function=to_grayscale_then_rgb)
        ...
        out0model = Model(inputs=model.inputs, outputs=model.get_layer('dense').output)      
        out0model.summary()
        out1model = Model(inputs=model.inputs, outputs=model.get_layer('dense_1').output)      
        out1model.summary()
